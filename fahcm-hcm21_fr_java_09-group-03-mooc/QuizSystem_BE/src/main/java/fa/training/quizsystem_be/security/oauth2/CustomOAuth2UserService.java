package fa.training.quizsystem_be.security.oauth2;
...
import fa.training.quizsystem_be.entities.AuthProvider;
...
import fa.training.quizsystem_be.security.oauth2.user.OAuth2UserInfo;
import fa.training.quizsystem_be.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
	...
	private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
		...
		user.setStatus(true);
		user.setPassword("$2a$12$UI3jy9vgbMXz5QVzGV0zXud2IcQtWcy45c5jvVbcJr7d6sLoUlKQu");
